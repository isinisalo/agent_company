...
Tämä dokumentti määrittää, mitä agentti saa päättää itse ja milloin työ pitää pysäyttää käyttäjän päätöstä varten. Käytä tätä yhdessä `doc-001 - goal.md`:n, bounded context -kartan ja Backlog-tehtävän kanssa.

## Artifact taxonomy

- `doc-001 - goal.md`: käyttäjän määrittämä GOAL, INTENT, WHY, WHAT, rajaukset ja korkean tason teknologiarajat.
...
Resetin jälkeen hyväksyttyjä korkean tason ADR:iä ovat `.backlog/decisions/decision-001` - `.backlog/decisions/decision-008`. Älä palauta tai käytä detail-tason Auth-päätöksiä 009-011 kanonisena lähteenä. Älä luo uutta ADR:ää ilman käyttäjän eksplisiittistä hyväksyntää.
...
2. `.backlog/docs/intent/doc-001 - goal.md`.
...
- päätös pysyy `doc-001 - goal.md`:n rajauksissa
