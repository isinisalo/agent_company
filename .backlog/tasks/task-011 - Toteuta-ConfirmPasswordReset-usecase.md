...
### MITÄ
Toteuta Auth-kontekstin salasanan resetoinnin vahvistus.
...
- [ ] #4 GIVEN `new_password` ei täytä taskissa määriteltyjä Password-validointisääntöjä, WHEN reset-vahvistusta yritetään, THEN pyyntö hylätään validointivirheenä eikä reset-tokenia tyhjennetä.
